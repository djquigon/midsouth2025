<?php
    ...
    $all_videos_button_text = $args['all_videos_button_text'];
    $all_videos_button_link = $args['all_videos_button_link'];

    $text_color_attribute = $args['text_color_attribute'];

    if ($module_title || ($all_videos_button_text && $all_videos_button_link)) : 
?>
