...
<article data-card-style="overlay" <?php if ($post_image_id) : ?>  style="background-image: url(<?= $post_image_url ?>)" <?php endif; ?>>
    <?php
        if ($post_image_id) :
    ?>
            <figure data-visually-hidden='true'> 
                ...
                >
                    <?php 
                        if ($args['trim_excerpt']) {
                            echo my_string_limit_words($post_excerpt, 15);
                        } else {
                            echo $post_excerpt;
                        }
                    ?>
